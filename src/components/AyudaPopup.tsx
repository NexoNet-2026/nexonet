...
const DATA: Record<TipoAyuda, Info> = {
  ...
  empresa: {
    ...
    items:[
      ...
      {emoji:"📥",titulo:"Descargas pagas",desc:"Vendé catálogos y guías — recibís 70% en BIT Promo"},
  ...
  pagina: {
    ...
    items:[
      ...
      {emoji:"📥",titulo:"Descargas",desc:"Ofrecé archivos gratuitos o de pago — recibís el 70% en BIT Promo por cada descarga"},
  ...
  descarga: {
    ...
    costo:"Free: gratis | Solicitud: el creador decide | Pago: vos fijás el precio — recibís 70% en BIT Promo",
    items:[
      ...
      {emoji:"💰",titulo:"Descarga paga",desc:"Fijás el precio en BIT — recibís el 70% en BIT Promo automáticamente al descargarse"},
