...
function MapaInner() {
  ...
  return (
    <div style={{fontFamily:"'Nunito',sans-serif"}}>
      ...
      {/* BARRA BUSCADOR */}
      <div style={{position:"fixed",top:"95px",left:0,right:0,background:"linear-gradient(135deg,#1a2a3a,#243b55)",padding:"10px 16px",zIndex:99,display:"flex",flexDirection:"column",gap:"8px"}}>
      ...
      {/* FILTROS TIPO */}
      <div style={{position:"fixed",top: modoConexion ? "200px" : "168px",left:0,right:0,zIndex:98,padding:"6px 12px",background:"linear-gradient(135deg,#1a2a3a,#243b55)",display:"flex",gap:"6px",overflowX:"auto",scrollbarWidth:"none"}}>
        {[
      ...
      {/* MAPA */}
      <div style={{position:"fixed",top: modoConexion ? "255px" : "223px",left:0,right:0,bottom:modoConexion?"190px":"130px"}}>
        {loading ? (
