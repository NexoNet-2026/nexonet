    ...
    <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 100 }}>
      ...
      <Link href="/grupos" style={{
        ...
        <span style={{ fontSize: "12px", fontWeight: 800, color: "#fff", letterSpacing: "0.3px" }}>
          Creá un{" "}
          <span style={{ color: "#d4a017", textTransform: "uppercase" }}>GRUPO GRATIS</span>
          {" "}y convertite en{" "}
          <span style={{ color: "#f0c040", textTransform: "uppercase" }}>PROMOTOR</span>
        </span>
        <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "16px", color: "#d4a017" }}>30%</span>
