...
const DATA: Record<TipoAyuda, Info> = {
  ...
  pagina: {
    ...
    items:[
      ...
      {emoji:"📥",titulo:"Descargas",desc:"Ofrecé archivos gratuitos o de pago — recibís el 90% en BIT Promo por cada descarga"},
  ...
  descarga: {
    ...
    costo:"Free: gratis | Solicitud: el creador decide | Pago: vos fijás el precio — recibís 90% en BIT Promo",
    items:[
      ...
      {emoji:"💰",titulo:"Descarga paga",desc:"Fijás el precio en BIT — recibís el 90% en BIT Promo automáticamente al descargarse"},
