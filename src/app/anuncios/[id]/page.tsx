        ...
        <div style={{ display: "flex", gap: "10px" }}>
          {anuncio.usuario_whatsapp && (
            <a href={`https://wa.me/54${anuncio.usuario_whatsapp}?text=Hola! Vi tu anuncio "${anuncio.titulo}" en NexoNet`}
              ...
              style={{ flex: 1, background: "#25D366", color: "#fff", border: "none", borderRadius: "12px", padding: "16px", fontSize: "14px", fontWeight: 800, textAlign: "center", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: "6px" }}>
              💬 WhatsApp
            </a>
          )}
