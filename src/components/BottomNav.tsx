...
import SoportePopup from "@/components/SoportePopup";
      ...
      {logueado && (
        <Link href="/nexo/crear/empresa" style={{
          ...
          <span style={{ fontSize: "12px", fontWeight: 800, color: "#fff", letterSpacing: "0.3px" }}>
            Creá tu <span style={{ color: "#d4a017" }}>NEGOCIO GRATIS</span> por
          </span>
      ...
      <nav style={{
        ...
        {navItems.map(({ icon, label, href, central }: any) => {
          const isActive = pathname === href ||
            ...
            (href === "/grupos" && (pathname?.startsWith("/nexo/") || pathname?.startsWith("/grupos")));
