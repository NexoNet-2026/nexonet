      ...
      <div style={{ display:"flex", flexDirection:"column", gap:"12px" }}>
        ...
        {items.length === 0 ? (
          <div style={{ background:"#fff", borderRadius:"16px", padding:"40px 20px", textAlign:"center", boxShadow:"0 2px 8px rgba(0,0,0,0.06)" }}>
            ...
            <button onClick={()=>router.push(`/publicar?tipo=${tipo}`)}
      ...
      <div style={{ padding:"16px", maxWidth:"480px", margin:"0 auto" }}>
        ...
        {seccion === "grupos" && (
          <div style={{ display:"flex", flexDirection:"column", gap:"12px" }}>
            ...
            <button onClick={()=>router.push("/publicar?tipo=grupo")} style={{ background:"rgba(212,160,23,0.08)", border:"2px dashed rgba(212,160,23,0.4)", borderRadius:"16px", padding:"16px", fontSize:"13px", fontWeight:800, color:"#d4a017", cursor:"pointer", fontFamily:"'Nunito',sans-serif", display:"flex", alignItems:"center", justifyContent:"center", gap:"8px" }}>
              ➕ Crear nuevo grupo
            </button>
          </div>
        )}
        ...
        <div onClick={() => setPopupAnuncio(null)}
          ...
          <div onClick={e => e.stopPropagation()}
            ...
            <div style={{ display:"flex", gap:"10px" }}>
              ...
              <button onClick={() => { setPopupAnuncio(null); setTimeout(() => router.push(`/anuncios/${popupAnuncio.id}`), 100); }}
                style={{ flex:2, background:"linear-gradient(135deg,#1a2a3a,#243b55)", border:"none", borderRadius:"12px", padding:"13px", fontSize:"14px", fontWeight:900, color:"#d4a017", cursor:"pointer", fontFamily:"'Nunito',sans-serif" }}>
