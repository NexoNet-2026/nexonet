...
function MapaInner() {
  ...
  return (
    <div style={{fontFamily:"'Nunito',sans-serif"}}>
      ...
      {/* FILTROS TIPO */}
      <div style={{position:"fixed",top: modoConexion ? "222px" : "207px",left:0,right:0,zIndex:98,padding:"6px 12px",background:"linear-gradient(135deg,#1a2a3a,#243b55)",display:"flex",gap:"6px",overflowX:"auto",scrollbarWidth:"none"}}>
        {[
      ...
      {/* MAPA */}
      <div style={{position:"fixed",top: modoConexion ? "272px" : "247px",left:0,right:0,bottom:modoConexion?"190px":"130px"}}>
        {loading ? (
